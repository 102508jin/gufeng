...
export const DEFAULT_MODEL_REQUEST_TIMEOUT_MS = 15_000;
export const MIN_COMPLETION_TOKEN_BUDGET = 4_096;
export const MAX_COMPLETION_TOKEN_BUDGET = 32_768;
export const DEFAULT_COMPLETION_TOKEN_BUDGET = 16_384;
export const COMPLETION_TOKEN_BUDGET_STEP = 1_024;
